...
var G__10994 = devtools.prefs.pref(v);
v = G__10994;
continue;
} else {
return v;
...
}catch (e10903){var _e__8845__auto__ = e10903;
return false;
}})();
...
}catch (e10920){var _e__8845__auto__ = e10920;
return false;
}})();
...
}catch (e10922){var _e__8845__auto__ = e10922;
return false;
}}
}
});
...
var vec__10944 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10944,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10944,(1),null);
...
return cljs.core.some((function (p1__10958_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10958_SHARP_);
}),template);
});
