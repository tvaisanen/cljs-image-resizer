...
var len__4771__auto___11290 = arguments.length;
var i__4772__auto___11291 = (0);
while(true){
if((i__4772__auto___11291 < len__4771__auto___11290)){
args__4777__auto__.push((arguments[i__4772__auto___11291]));

var G__11292 = (i__4772__auto___11291 + (1));
i__4772__auto___11291 = G__11292;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11184){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11185,G__11186,seq11184__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11198_SHARP_){
return (!((cljs.core.meta(p1__11198_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11237__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11244){var _e__8845__auto__ = e11244;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e11246){var _e__8845__auto__ = e11246;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11248 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11249 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11249);

try{var map__11254 = opts;
var map__11254__$1 = cljs.core.__destructure_map(map__11254);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11254__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11248);
}});
...
var temp__5733__auto___11338 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___11338)){
var managed_print_level_11340 = temp__5733__auto___11338;
var _STAR_print_level_STAR__orig_val__11265_11342 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11266_11343 = managed_print_level_11340;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11266_11343);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11261_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11261_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11265_11342);
}} else {
job_fn();
}
