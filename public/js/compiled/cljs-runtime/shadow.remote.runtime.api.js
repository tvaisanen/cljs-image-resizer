...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33361 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33361(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33362 = (function (runtime,key,spec){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33362(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33364 = (function (runtime,key){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33364(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33365 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33365(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33367 = (function (runtime,input,callback){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33367(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33370 = (function (runtime,code){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33370(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33359,callback){
var map__33360 = p__33359;
var map__33360__$1 = cljs.core.__destructure_map(map__33360);
var input = map__33360__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33360__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33360__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
