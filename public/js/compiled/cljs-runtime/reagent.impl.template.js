...
var G__12358 = o;
(G__12358[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12360){
var map__12361 = p__12360;
var map__12361__$1 = cljs.core.__destructure_map(map__12361);
var props = map__12361__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12361__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12362){
var map__12363 = p__12362;
var map__12363__$1 = cljs.core.__destructure_map(map__12363);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12363__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__12367){
var map__12368 = p__12367;
var map__12368__$1 = cljs.core.__destructure_map(map__12368);
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12368__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12368__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__12369 = jsprops;
(G__12369["defaultValue"] = value);

(G__12369["onChange"] = (function (p1__12364_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__12364_SHARP_);
}));
...
var vec__12371 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12371,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12371,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12371,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___12409 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___12409 == null)){
} else {
var key_12410 = temp__5739__auto___12409;
(jsprops["key"] = key_12410);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__12377){
var map__12378 = p__12377;
var map__12378__$1 = cljs.core.__destructure_map(map__12378);
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12378__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__12379 = reagent.impl.template.__GT_NativeWrapper();
(G__12379["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__12380 = wrapped;
(G__12380["syntheticInput"] = true);

return G__12380;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__12381 = wrapped__$1;
(G__12381["syntheticOnChange"] = on_change);

return G__12381;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__12382 = wrapped__$2;
(G__12382["syntheticOnUpdate"] = on_update);
...
var len__4771__auto___12423 = arguments.length;
var i__4772__auto___12424 = (0);
while(true){
if((i__4772__auto___12424 < len__4771__auto___12423)){
args__4777__auto__.push((arguments[i__4772__auto___12424]));

var G__12425 = (i__4772__auto___12424 + (1));
i__4772__auto___12424 = G__12425;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12386){
var G__12387 = cljs.core.first(seq12386);
var seq12386__$1 = cljs.core.next(seq12386);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12387,seq12386__$1);
}));
...
break;
default:
var G__12428 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12428;
continue;
...
var n__4648__auto___12447 = a.length;
var i_12452 = (0);
while(true){
if((i_12452 < n__4648__auto___12447)){
(a[i_12452] = reagent.impl.template.as_element((a[i_12452])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4648__auto___12458 = a.length;
var i_12459 = (0);
while(true){
if((i_12459 < n__4648__auto___12458)){
var val_12460 = (a[i_12459]);
if(((cljs.core.vector_QMARK_(val_12460)) && ((reagent.impl.template.key_from_vec(val_12460) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12459] = reagent.impl.template.as_element(val_12460));

var G__12461 = (i_12459 + (1));
i_12459 = G__12461;
continue;
} else {
}
...
var ctx = ({});
var vec__12390 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12390,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12390,(1),null);
...
var G__12393 = (cljs.core.count(argv) - first_child);
switch (G__12393) {
case (0):
