...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29200 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29200(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29204 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29204(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29205 = (function (reader,ch){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29205(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29208 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29208(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29211 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29211(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29212 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29212(reader);
}
});
...
var G__29224 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29225 = s.append(c);
c = G__29224;
s = G__29225;
continue;
}
