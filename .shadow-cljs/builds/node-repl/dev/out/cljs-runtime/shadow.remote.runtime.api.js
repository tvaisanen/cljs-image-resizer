...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30069 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30069(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30076 = (function (runtime,key,spec){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30076(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30090 = (function (runtime,key){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30090(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30091 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30091(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30092 = (function (runtime,input,callback){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30092(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30094 = (function (runtime,code){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30094(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30067,callback){
var map__30068 = p__30067;
var map__30068__$1 = cljs.core.__destructure_map(map__30068);
var input = map__30068__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30068__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30068__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
